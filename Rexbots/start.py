...
# Sirf 10 best aur premium reactions
REACTIONS = [
    "👍", "❤️", "🔥", "🥰", "👏", "🎉", "🤩", "🚀", "⚡", "💯"
]

# Custom Developer Info
dev_text = "👨‍💻 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐝 & 𝐌𝐚𝐢𝐧𝐭𝐚𝐢𝐧𝐞𝐝 𝐁𝐲:\n• @usrhtff009"
channels_text = "📢 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 𝐂𝐡𝐚𝐧𝐧𝐞𝐥:\n• https://t.me/usrht01\n\nJoin for the latest features & updates!"
...
<b>🛡️ Security: End-to-End Encrypted</b>

<b>👇 Select an Option Below to Get Started:</b>
"""
    HELP_TXT = """<b>📚 𝐂𝐨𝐦𝐩𝐫𝐞𝐡𝐞𝐧𝐬𝐢𝐯𝐞 𝐇𝐞𝐥𝐩 & 𝐔𝐬𝐞𝐫 𝐆𝐮𝐢𝐝𝐞</b>

<b>1️⃣ Public Channels (No Login Required)</b>
• Forward or send the post link directly.
• <i>Example Link:</i> <code>https://t.me/channel/123</code>

<b>2️⃣ Private/Restricted Channels (Login Required)</b>
• Use <code>/login</code> to securely connect your Telegram account.
• Send the private link (e.g., <code>t.me/c/123...</code>).

<b>3️⃣ Batch Downloading Mode</b>
• Send a link range like <code>https://t.me/c/123/10-20</code>.
...
• Contact @usrhtff009 for upgrades.
"""
    ABOUT_TXT = """<b>ℹ️ 𝐀𝐛𝐨𝐮𝐭 𝐓𝐡𝐢𝐬 𝐁𝐨𝐭</b>

<b>╭────[ 🧩 Technical Stack ]────⍟</b>
<b>├⍟ 🤖 Bot Name : <a href="https://t.me/usrht01">Save Restricted Bot</a></b>
<b>├⍟ 👨‍💻 Developer : <a href="https://t.me/usrhtff009">@usrhtff009</a></b>
<b>├⍟ 📚 Library : Pyrogram Async</b>
<b>├⍟ 🐍 Language : Python 3.11+</b>
<b>├⍟ 🗄 Database : MongoDB Atlas</b>
<b>├⍟ 📡 Hosting : Dedicated High-Speed VPS</b>
<b>╰───────────────⍟</b>
"""
    PREMIUM_TEXT = """<b>💎 𝐏𝐫𝐞𝐦𝐢𝐮𝐦 𝐌𝐞𝐦𝐛𝐞𝐫𝐬𝐡𝐢𝐩 𝐏𝐥𝐚𝐧𝐬</b>
...
<b>🖼 Customizable Thumbnails & Captions</b>

<b>👇 Secure Payment:</b>
<b>💸 UPI ID:</b> <code>{}</code>
<b>📸 QR Code:</b> <a href='{}'>Scan to Pay</a>

<i>After Payment: Send Screenshot to @usrhtff009 for Instant Activation.</i>
"""
    PROGRESS_BAR = """\
<b>⚡ 𝐏𝐫𝐨𝐜𝐞𝐬𝐬𝐢𝐧𝐠 𝐓𝐚𝐬𝐤...</b>
...
"""
    CAPTION = """<b>⚜️ Powered By : <a href="https://t.me/usrht01">@usrhtff009</a></b>"""
    LIMIT_REACHED = """<b>🚫 𝐃𝐚𝐢𝐥𝐲 𝐋𝐢𝐦𝐢𝐭 𝐄𝐱𝐜𝐞𝐞𝐝𝐞𝐝</b>
...
Contact @usrhtff009 to remove all restrictions.
"""
    SIZE_LIMIT = """<b>⚠️ 𝐅𝐢𝐥𝐞 𝐒𝐢𝐳𝐞 𝐄𝐱𝐜𝐞𝐞𝐝𝐞𝐝</b>
<b>Free tier limited to 2GB per file.</b>

<b>🔓 Upgrade to Premium</b>
Download files up to 4GB and beyond with no limits! Contact @usrhtff009.
"""
    ...
    while os.path.exists(statusfile):
        try:
            with open(statusfile, "r", encoding='utf-8') as downread:
                txt = downread.read()
            await client.edit_message_text(chat, message.id, f"{txt}", parse_mode=enums.ParseMode.HTML)
...
async def send_start(client: Client, message: Message):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton('📢 Updates Channel', callback_data="channels_info"),
...
async def send_plan(client: Client, message: Message):
    buttons = [
        [InlineKeyboardButton("📸 Send Payment Proof", url="https://t.me/usrhtff009")],
...
async def handle_restricted_content(client: Client, acc, message: Message, chat_target, msgid):
    ...
    try:
        ...
        if msg_type == "Document":
         ...
         await smsg.edit(f"<b>❌ Upload Failed:</b> {e}", parse_mode=enums.ParseMode.HTML)
